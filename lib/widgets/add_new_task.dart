...
import 'package:flutter_application_1/providers/task.dart';
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('Tanggal', style: Theme.of(context).textTheme.subtitle2),
                  TextFormField(
                    onTap: () {
                      _pickUserDueDate();
                    },
                  ...
                  Text('Jam', style: Theme.of(context).textTheme.subtitle2),
                  TextFormField(
                    onTap: () {
                      _pickUserDueTime();
                    },
